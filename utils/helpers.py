...
def get_background(dataset):
    """
    Returns background value depending on the dataset.
    Used for visualization padding (e.g., white or black background).
    """
    # You can customize this depending on your dataset
    if hasattr(dataset, 'name') and dataset.name.lower() in ['dsprites', '3dshapes']:
        return 0.0  # black background
    else:
        return 1.0  # white background
